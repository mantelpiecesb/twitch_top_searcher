...
@Database(
    entities = [TwitchItem::class, RemoteKeys::class],
    version = 1,
    exportSchema = false
)
abstract class TwitchDatabase : RoomDatabase() {

    abstract fun reposDao(): TwitchDao
    abstract fun remoteKeysDao(): RemoteKeysDao

    companion object {

        @Volatile
        private var sINSTANCE: TwitchDatabase? = null
        ...
        private fun buildDatabase(context: Context) =
            Room.databaseBuilder(
                ...
                TwitchDatabase::class.java, "TwitchDB.db"
            )
                .build()
    }
}
